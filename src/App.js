...
const App = () => {
  ...
  const read_state = async () => {
    const ENDPOINTS = {
      smartphone: "https://fantastic-neckerchief-dog.cyclic.app/productos-smartphone",
      tvs: "https://fantastic-neckerchief-dog.cyclic.app/productos-tvs",
      audio: "https://fantastic-neckerchief-dog.cyclic.app/productos-audio",
      destacados: "https://fantastic-neckerchief-dog.cyclic.app/productos-destacados",
      carrito: "https://fantastic-neckerchief-dog.cyclic.app/carrito",
      favoritos: "https://fantastic-neckerchief-dog.cyclic.app/favoritos"     
    };
  ...
  const addToCart = async (data) => {
    ...
    if(itemInCarrito){
      let ENDPOINTS = `https://fantastic-neckerchief-dog.cyclic.app/carrito/${data.id}`
      ...
      let res = await axios("https://fantastic-neckerchief-dog.cyclic.app/carrito", OPTIONS),
      itemData = await res.data
  ...
  const clearCart = async () => {
    ...
    state.carrito.map((prod) => {
      ...
      let ENDPOINTS = `https://fantastic-neckerchief-dog.cyclic.app/carrito/${prod.id}`
  ...
  const addToFav = async (data) => {
    ...
    if(itemInCarrito){
      ...
      let ENDPOINTS = `https://fantastic-neckerchief-dog.cyclic.app/favoritos/${data.id}`
      ...
      let res = await axios("https://fantastic-neckerchief-dog.cyclic.app/favoritos", OPTIONS),
      itemData = await res.data
